...
export function Ping() {
  return (
    <div className="divider-wrapper my-20">
      <Reverse />
      <Straight />
    </div>
  );
      ...
      >
        <div className="slider flex gap-x-4 pr-4" ref={firstContainer}>
          {Array(13)
            ...
            .map((index) => (
              <p
                className="text-blueDark font-title text-xl min-w-20 text-center"
      ...
      >
        <div className="slider flex gap-x-4 pl-4" ref={firstContainer}>
          {Array(13)
            ...
            .map((index) => (
              <p
                className="text-pink font-title text-xl min-w-20 text-center"
                key={Math.random() * 10 - index}
              >
                Ping
              </p>
